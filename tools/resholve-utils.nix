# This is a copy of nixpkgs/pkgs/development/misc/resholve/resholve-utils.nix, with
# a small patch to mkDerivation to accept the postResholveFixup parameter. It's needed
# so we can reference the resholved derivation in replacements for files other than
# scripts (.service files, systemd units, etc).
